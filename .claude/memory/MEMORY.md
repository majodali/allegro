...
- design_type_system_meta_types, design_type_definitions → `docs/design/type-system.md`
- design_effects_as_values → `docs/design/effects.md`
- design_pattern_matching → `docs/design/pattern-matching.md`
- design_brace_offside_modes → `docs/design/grammar.md`
