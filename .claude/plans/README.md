...
| `equality-and-laws.md` | B-027: equality protocol + lawful interfaces (structures.md §7–8) — kernel structural equals, declared coercions, law members, discharge tiers | **draft** | Ratification-pass deliverable; §3 decisions E-R1–E-R6 awaiting maintainer sign-off before chunk E1. Recon found `[1,2]==[1,2]` and `{x:1}=={x:1}` host-CRASH today (§2 table) |
