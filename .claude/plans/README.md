...
| `units-dsl.md` | B-092: rung-2 units-of-measure physics DSL — dimensions as data + refinement-typed quantities, grammar sugar, domain-term errors, laws with honest tiers | **draft** | Brief composed 2026-08; U-R1 representation bet pre-validated by entry test; U-R1–U-R5 awaiting maintainer ratification before chunk U1 |
