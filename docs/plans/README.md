...
| `completion-effects.md` | B-028: completion effects & futures — D16/D31–D34 execution (`div` computed effect + D34 tiers, typed `Future[T]`, `is_resolved` as effect, D32 triggered guard, substrate hardening) | **draft** | CE-R1–CE-R8 proposed with recommendations 2026-08; awaiting maintainer ratification — no chunk starts before the gate |
