...
| `visibility.md` | B-097: S3 mediated-member arc — D41/D42/D43 execution (pipeline, evidence capsule, private members, forgery E) | **draft** | V-R1–V-R8 + forgery-E criterion awaiting maintainer ratification; chunks V1–V4 sequenced; no chunk starts before the gate |
